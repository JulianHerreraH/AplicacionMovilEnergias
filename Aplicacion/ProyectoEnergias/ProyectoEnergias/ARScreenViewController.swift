...
class ARScreenViewController: UIViewController, ARSCNViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let scene =    SCNScene()
        let esfera    =    SCNSphere(radius:    0.5)
        let materialTierra =    SCNMaterial()
        materialTierra.diffuse.contents =    UIImage(named:"light-bulb.png")
