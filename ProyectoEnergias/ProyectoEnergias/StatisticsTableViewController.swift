...
class StatisticsTableViewController: UITableViewController, UISearchResultsUpdating{
    ...
    let dataStringURL = "http://martinmolina.com.mx/201911/data/ProyectoEnergiasRenovables/StatsTitleGlobal.json"
    var dataObj: [Any]?
    var receivedId = -1
    var currentSection = ""
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let objectData = filteredData[0] as! [String:Any]
        siguiente.clickedSection = "Global"
