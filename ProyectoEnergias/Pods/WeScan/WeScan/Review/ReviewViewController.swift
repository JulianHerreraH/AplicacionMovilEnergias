...
final class ReviewViewController: UIViewController {
    ...
    lazy private var enhanceButton: UIBarButtonItem = {
        let image = UIImage(named: "Mejorar", in: Bundle(for: ScannerViewController.self), compatibleWith: nil)
    ...
    lazy private var rotateButton: UIBarButtonItem = {
        let image = UIImage(named: "Rotar", in: Bundle(for: ScannerViewController.self), compatibleWith: nil)
